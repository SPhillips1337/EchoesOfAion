...
CREATE INDEX IF NOT EXISTS idx_stars_coords ON stars (x_coord, y_coord);
...
CREATE INDEX IF NOT EXISTS idx_planets_resources ON planets USING GIN (resources);
...
CREATE INDEX IF NOT EXISTS idx_star_lanes_source ON star_lanes (source_star_id);
CREATE INDEX IF NOT EXISTS idx_star_lanes_destination ON star_lanes (destination_star_id);
...
CREATE INDEX IF NOT EXISTS idx_fleets_empire_id ON fleets (empire_id);
CREATE INDEX IF NOT EXISTS idx_fleets_star_id ON fleets (star_id);
CREATE INDEX IF NOT EXISTS idx_fleets_composition ON fleets USING GIN (composition);
...
CREATE INDEX IF NOT EXISTS idx_structures_planet_id ON structures (planet_id);
...
CREATE INDEX IF NOT EXISTS idx_build_queues_entity ON build_queues (entity_type, entity_id);
...
CREATE INDEX IF NOT EXISTS idx_turn_history_empire_id ON turn_history (empire_id);
CREATE INDEX IF NOT EXISTS idx_turn_history_turn ON turn_history (empire_id, turn_number);
CREATE INDEX IF NOT EXISTS idx_turn_history_actions ON turn_history USING GIN (actions);
